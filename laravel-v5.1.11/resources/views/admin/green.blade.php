...
<script>
	$("#button").click(function(){
		...
		$.ajax({ 
			type:"GET",
			url:"http://www.ten.com/green?callback=?",
			data:{name:name,sex:sex,national:national,phone:phone,birthday:birthday,card:card,phone2:phone2,live_address:live_address,detailed_address:detailed_address,family_member_one:family_member_one,relation_one:relation_one,work_units_one:work_units_one,year_money_one:year_money_one,family_member_two:family_member_two,relation_two:relation_two,work_units_two:work_units_two,year_money_two:year_money_two,family_member_three:family_member_three,relation_three:relation_three,work_units_three:work_units_three,year_money_three:year_money_three,reason:reason},
			dataType:"jsonp",
			// jsonp:"jsoncallback",
